...
from utils.constants import DATABASE_TABLES, SCHEMA_NAME, PLAYERS_FILE_LOG
from utils.logger import configure_logger
from utils.fetcher import Fetcher

LOGGER = configure_logger(__name__, PLAYERS_FILE_LOG)
            ...
            if last_page:
                for page in range(1, last_page + 1):
                    ...
                    try:
                        ...
                        insert_data(connection, SCHEMA_NAME, DATABASE_TABLES[2], players)
