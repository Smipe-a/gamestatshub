...
import psycopg2
import re
from utils.constants import DATABASE_TABLES, SCHEMA_NAME, GAMES_FILE_LOG
from utils.database.connector import connect_to_database, insert_data
from utils.logger import configure_logger
from utils.fetcher import Fetcher

LOGGER = configure_logger(__name__, GAMES_FILE_LOG)
            ...
            if last_page:
                for page in range(1, last_page + 1):
                    ...
                    try:
                        ...
                        insert_data(connection, SCHEMA_NAME, DATABASE_TABLES[0], games)
                        insert_data(connection, SCHEMA_NAME, DATABASE_TABLES[1], achievements)
